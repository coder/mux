...
function renderSubAgentGallery() {
  ...
  // title) — a non-deterministic Storybook snapshot diff. Pin to unread (matching the
...
export const SubAgentStates: Story = {
  ...
  // state (success-colored status dot). With no play() the Storybook test-runner races that
