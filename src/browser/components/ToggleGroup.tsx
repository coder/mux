  ...
  if (compact) {
    ...
    return (
      <button
        ...
        type="button"
        className={cn(
          "px-1.5 py-0.5 text-[11px] font-sans rounded-sm border-none cursor-pointer transition-colors duration-150",
      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            type="button"
            className={cn(
              "px-1.5 py-0.5 text-[11px] font-sans rounded-sm border-none cursor-pointer transition-colors duration-150 bg-transparent",
              isActive
                ? "text-toggle-text-active bg-toggle-active font-medium"
