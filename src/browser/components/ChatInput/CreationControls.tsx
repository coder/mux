    ...
    <div className="mb-3 flex flex-col gap-4">
      ...
      <div className="flex items-center" data-component="WorkspaceNameGroup">
        ...
        <div className="relative inline-grid max-w-sm items-center">
          ...
          <span className="invisible col-start-1 row-start-1 whitespace-pre pr-4 text-lg font-semibold">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <input
                ...
                className={cn(
                  "col-start-1 row-start-1 min-w-0 bg-transparent border-border-medium focus:border-accent h-7 w-full rounded-md border border-transparent pr-4 text-lg font-semibold focus:border focus:bg-bg-dark focus:outline-none disabled:opacity-50",
