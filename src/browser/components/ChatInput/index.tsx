  ...
  const creationControlsProps =
    variant === "creation"
      ? ({
          ...
          createOnRemote: creationState.createOnRemote,
          onCreateOnRemoteChange: creationState.setCreateOnRemote,
          remoteServerId: creationState.remoteServerId,
          onRemoteServerIdChange: creationState.setRemoteServerId,
