...
export const HyperExpandedBundle: AppStory = {
  // The Storybook test-runner executes this play function for the visual snapshot,
  // while the app-level UI test covers expansion behavior without Storybook's manager-page timing.
  tags: ["!test"],
  render: () => <AppWithMocks setup={() => setupTranscriptDensityStory("hyper")} />,
