...
export function gitStatusCommand(workspaceId?: string) {
  ...
  if (workspaces.length === 0) {
    console.log("No workspaces found! Check that ~/.xum/src/ contains workspace directories.");
    process.exit(1);
  }
