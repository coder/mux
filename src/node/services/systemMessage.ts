...
// repurposing useful context over routine cleanup.
const PRELUDE = ` 
<prelude>
...
- When assigning new standalone work, first consider known inactive children. Prefer reawakening one when its prior context or expertise is relevant, and retitle it when its reusable responsibility changes. Spawn a new child when no existing context fits; do not force unrelated work into a stale context.
