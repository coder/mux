...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "mux-docs": {
    ...
    "references/docs/adr/0002-image-editing-visual-mockups.md": [
      "---",
    ...
    "references/docs/extensions/authoring.mdx": [
      "---",
    ...
    "references/docs/extensions/release-checklist.mdx": [
      "---",
    ...
    "references/docs/extensions/telemetry.mdx": [
      "---",
