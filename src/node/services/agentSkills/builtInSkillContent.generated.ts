...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "mux-docs": {
    ...
    "references/docs/hooks/tools.mdx": [
      ...
      "| `MUX_TOOL_INPUT_SCRIPT_SOURCE`     | `script_source`     | string  | Inline JavaScript workflow source for compact one-off conductors. The exact source is snapshotted into the durable run for replay/resume.                                                                                                                                                                                                                                |",
      "",
      "</details>",
      "",
