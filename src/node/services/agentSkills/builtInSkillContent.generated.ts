...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "mux-docs": {
    ...
    "references/docs/config/models.mdx": [
      ...
      "",
      "The image model is configured separately from the chat model. The default is `openai:gpt-image-1.5`; use `openai:gpt-image-1.5-2025-12-16` if you need a pinned model snapshot. The first experiment is OpenAI-only and requires OpenAI provider credentials in **Settings → Providers**.",
      "",
