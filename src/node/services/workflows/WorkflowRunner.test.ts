...
`,
    ...
    await expect(runner.run("wfr_legacy_unstarted_invalid_schema")).rejects.toThrow();
  });
...
`,
    ...
    await expect(runner.run("wfr_legacy_stale_started_invalid_schema")).rejects.toThrow();
