...
- Every `agent` / `parallelAgents` item must have a stable `id`.
- The replay key includes the step ID and normalized spec, so changing prompts or schemas creates new work.
