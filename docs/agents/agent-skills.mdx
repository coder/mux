...
The Mux repository includes a hidden `master` skill that encourages aggressive use of sub-agents for parallel exploration. Invoke it with `/master` when you want the agent to prioritize parallelism. This skill is defined in `.mux/skills/master/SKILL.md`.
