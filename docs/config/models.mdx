...
The first version is generate-only. It supports prompt, image count, quality, and output format. Generated full-resolution images are saved as runtime artifacts; copy selected final assets into the workspace when they should become project files.
