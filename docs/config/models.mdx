...
| GPT-5.6 Terra          | openai:gpt-5.6-terra          | `gpt`, `gpt-5.6`, `gpt-5.6-terra`                            |         |
| GPT-5.6 Sol            | openai:gpt-5.6-sol            | `gpt-pro`, `gpt-5.6-pro`, `gpt-5.6-sol`                      |         |
| GPT-5.6 Luna           | openai:gpt-5.6-luna           | `gpt-mini`, `gpt-5.6-mini`, `gpt-5.6-luna`                   |         |
...
- `0` = model's lowest allowed level (e.g., `off` for Sonnet, `medium` for GPT-5.6 Sol)
- Higher numbers select progressively higher levels, clamped to the model's maximum

This means `/sonnet+0` disables thinking while `/gpt-pro+0` sets thinking to medium (GPT-5.6 Sol's minimum).
