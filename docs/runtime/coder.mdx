...
1. Choose **Coder** as the runtime and select **Existing**.
...
- If the **Coder** runtime option is missing, verify that the Coder CLI is found on the PATH.
