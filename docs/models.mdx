...
| Model                                                | Provider  | Aliases                                  | Default |
| ---------------------------------------------------- | --------- | ---------------------------------------- | ------- |
| Opus 4.5 (`anthropic:claude-opus-4-5`)               | Anthropic | `opus`                                   | Yes     |
| Sonnet 4.5 (`anthropic:claude-sonnet-4-5`)           | Anthropic | `sonnet`                                 | —       |
| Haiku 4.5 (`anthropic:claude-haiku-4-5`)             | Anthropic | `haiku`                                  | —       |
| GPT-5.1 (`openai:gpt-5.1`)                           | OpenAI    | `gpt-5.1`                                | —       |
| GPT-5 Pro (`openai:gpt-5-pro`)                       | OpenAI    | `gpt-5-pro`                              | —       |
| GPT-5.1 Codex (`openai:gpt-5.1-codex`)               | OpenAI    | `codex`                                  | —       |
| GPT-5.1 Codex Mini (`openai:gpt-5.1-codex-mini`)     | OpenAI    | `codex-mini`                             | —       |
| GPT-5.1 Codex Max (`openai:gpt-5.1-codex-max`)       | OpenAI    | `codex-max`                              | —       |
| Gemini 3 Pro Preview (`google:gemini-3-pro-preview`) | Google    | `gemini-3`, `gemini-3-pro`               | —       |
| Grok 4 1 Fast (`xai:grok-4-1-fast`)                  | xAI       | `grok`, `grok-4`, `grok-4.1`, `grok-4-1` | —       |
| Grok Code Fast 1 (`xai:grok-code-fast-1`)            | xAI       | `grok-code`                              | —       |
