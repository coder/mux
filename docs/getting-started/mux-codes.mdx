...
1. Under Providers, enter the code under Mux Gateway:
   ![Mux Gateway Code](../img/mux-codes-1.webp)
1. Under Models, ensure the Mux Gateway button is toggled for the model you want to use
   ![Mux Gateway Model](../img/mux-codes-2.webp)
   - Optionally, click Star to set the model as your default model.
