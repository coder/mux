...
<details>
<summary>timeline_mark (3)</summary>

| Env var                   | JSON path  | Type   | Description                          |
| ------------------------- | ---------- | ------ | ------------------------------------ |
| `MUX_TOOL_INPUT_CATEGORY` | `category` | enum   | Optional marker category.            |
| `MUX_TOOL_INPUT_DETAIL`   | `detail`   | string | Optional supporting detail.          |
| `MUX_TOOL_INPUT_LABEL`    | `label`    | string | Short label for the timeline marker. |
