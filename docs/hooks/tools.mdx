...
| `MUX_TOOL_INPUT_TITLE`                         | `title`                       | string  | Parent-chosen durable title for the child workspace. Name the sub-agent's long-term area of expertise, not the current one-off assignment.                                                                                                                                                                                                                                                                                                                                                               |
