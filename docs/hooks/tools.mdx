...
| `MUX_TOOL_INPUT_TITLE`                         | `title`                       | string  | Parent-chosen short, friendly role name for the persistent child, such as "Reviewer" or "Simplicity Auditor". Name reusable expertise, not the current assignment; avoid task-summary titles such as "Analyze lifecycle semantics".                                                                                                                                                                                                                                                                      |
