...
| `MUX_TOOL_INPUT_MONITOR_COOLDOWN_MS`    | `monitor.cooldown_ms`    | number  | Coalesce matches that occur within this window into a single wake event.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `MUX_TOOL_INPUT_MONITOR_FILTER`         | `monitor.filter`         | string  | Regex applied per stdout/stderr line at write time. Matching lines wake the agent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `MUX_TOOL_INPUT_MONITOR_FILTER_EXCLUDE` | `monitor.filter_exclude` | boolean | Invert match: matching lines are dropped, non-matching lines wake the agent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `MUX_TOOL_INPUT_MONITOR_MAX_EVENTS`     | `monitor.max_events`     | number  | Auto-stop monitoring after this many matches; the process keeps running.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
