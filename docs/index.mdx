...
**Mux** makes it easy to run parallel coding agents, each with its own isolated workspace, right from your browser or desktop.
...
<Columns cols={2}>
  ...
  <Card title="Get Mux Gateway Credits" icon="key" href="/getting-started/mux-codes">
    Get started with free LLM credits via Mux Gateway.
  </Card>
</Columns>
