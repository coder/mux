...
When no name is provided, `/fork` auto-generates an incremented name and title:

| Source               | First fork      | Second fork     |
| -------------------- | --------------- | --------------- |
| Name: `bugs-asd23`   | `bugs-asd23-2`  | `bugs-asd23-3`  |
| Title: `Fixing bugs` | `Fixing bugs 2` | `Fixing bugs 3` |
...
- Uses the provided or auto-generated workspace name (you can rename later)
