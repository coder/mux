...
description: >-
  ...
  Use this skill when a story under "Docs/README Screenshots" changes
  visually, or when story data/layout changes require updated documentation
  assets. Triggers on: visual changes in readme screenshot stories,
  changes to App.readmeScreenshots.stories.tsx,
...
change visually (detected by local inspection or review), the corresponding WebP
...
1. **Visual changes detected** in any `Docs/README Screenshots` story
