...
| ------------------ | ---------------------------------- | ---------------------------------------- |
| `#09090b`          | `--color-surface-primary`          | page, transcript, and composer interior  |
...
Two consequences for the composer: the prompt has no fill or border of its own (one bordered box
holds the textarea and the pill row, and its interior is the page background), and
`--color-composer-send` is a new per-theme token because the design's cyan is not
`--color-accent`'s blue.
