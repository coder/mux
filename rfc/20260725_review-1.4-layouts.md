...
- **Thinking level color**: the design shows `max` in the same grey as the model name; the app
  keeps `--color-thinking-mode` and its weight ramp because the color encodes the level.
