import type { ParsedCommand } from "@shared/utils/slashCommands/types";
import type { RuntimeConfig } from "@shared/types/runtime";
import { RUNTIME_MODE, SSH_RUNTIME_PREFIX } from "@shared/types/runtime";
import type { FrontendWorkspaceMetadata } from "../types";
import type { CmuxMobileClient, SendMessageOptions } from "../api/client";
import { buildMobileCompactionPayload } from "./slashCommandHelpers";

export interface SlashCommandRunnerContext {
  api: Pick<CmuxMobileClient, "workspace" | "providers" | "projects">;
